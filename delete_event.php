...
while($row = mysql_fetch_array($result)){
    ...
    <div class="event_display">
      <form id="register-form" action="process_delete_event_admin.php" method="post">          
        <div>
  ...
  <div class="event_more">
    <div class="portfoliotext2">
      <button type="submit" class="button" onclick="return confirm('Are you sure?')">Delete Event!</button>
      </form>
    </div>
  </div>
